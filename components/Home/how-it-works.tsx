...
export function CarRentalHowItWorks() {
  // Memoized steps (never re-created)
  const memoSteps = React.useMemo(() => howItWorksSteps, []);

  // Memoized TracingBeam (heavy animation → no re-render)
  const MemoizedBeam = React.useMemo(() => {
    return (
      <TracingBeam className="px-4 sm:px-6">
        <div className="max-w-5xl mx-auto relative space-y-20 md:space-y-24">
          {memoSteps.map((item, index) => (
...
const howItWorksSteps: Step[] = [
  {
    ...
    description: (
      <>
        <p>
          ...
          Whether within the city or outstation, we’ve got you covered.
        </p>
        <p>
    ...
    badge: "Step 1",
    features: ["Pickup & Drop Selection", "Multi-City Coverage", "Live Availability"],
  ...
  },
  {
    ...
    badge: "Step 2",
    features: ["Economy to Luxury Options", "Group-Friendly Vehicles", "Verified Drivers"],
  ...
  },
  {
    ...
    description: (
      <>
        <p>
          Complete your booking securely via UPI, cards, wallets, or net banking
  ...
  },
  {
    ...
    description: (
      <>
        ...
        <p>Get 24/7 support for any help during your trip.</p>
      </>
    ),
    badge: "Step 4",
    features: ["Professional Chauffeurs", "On-Time Pickup", "24/7 Customer Support"],
