    ...
    >
      <div className="group/card rounded-3xl w-full relative overflow-hidden bg-transparent flex items-center justify-center h-full">
        <div className="relative z-10 flex items-center justify-center flex-col">
          ...
          <div className="relative h-28 w-44 md:h-40 md:w-60 rounded-xl md:rounded-lg flex items-center justify-center overflow-hidden mb-2 md:mb-3 transition-all duration-300 group-hover/card:scale-105">
            <Image
        ...
        {/* Hover Effect */}
        <div className="absolute inset-0 bg-gradient-to-br from-transparent via-transparent to-black/5 dark:to-white/5 rounded-3xl opacity-0 group-hover/card:opacity-100 transition-opacity duration-300" />
      </div>
    </div>
  );
};
